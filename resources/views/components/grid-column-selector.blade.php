<div class="dropdown pull-right column-selector">
    ...
    <ul class="dropdown-menu" role="menu">
        ...
        <li class="divider"></li>
        <li class="text-right d-flex">
            <button class="btn btn-info column-select-all mr-2">{{ __('admin.all') }}</button>&nbsp;&nbsp;
            <button class="btn btn-primary column-select-submit">{{ __('admin.submit') }}</button>
        </li>
    </ul>
</div>
